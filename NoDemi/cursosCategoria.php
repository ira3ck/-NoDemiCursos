...
<html>
    ...
    <body>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET") {
            $categoriaActual = $_GET["variable1"];
    ...
    <!-- FIN NAVBAR -->
        ...
        <div class="contGlobal">
            ...
            <div class="mainContent" style="min-height: 130em;">
                <div class="contariner">
                            <h3>Cursos de <?php echo "$categoriaActual"; ?> </h3>
                            <br>
                            <br>
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="separador">Para principiantes</div>
                            <div class="row text-center">
                                <?php
                                $curso->categoriasIguales($categoriaActual, 1, 6);
                                ?>
                            </div>
                            <br><br><br>
                            <div class="separador">mejores calificados</div>
                            <div class="row text-center">
                                <div class="col">
                                    <div class="tarjeta">
                                        <img src="https://cdn.discordapp.com/attachments/401063050464985091/820201212220538909/unknown.png" alt="">
                        ...
                        <br>
                <form action="cursosCategoria.php" method="get" class="">
                <div class="row">
                ...
                <div class="col-8">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                           ...
                           <input type="hidden" name="variable1" value=<?php echo '"'.$categoriaActual.'"'  ?> />
                ...
                <div class="row text-center">
                    <?php
                        $curso->buscar2Categorias($busqueda, $inicio, $fin, $opcFecha,$opcTitulo,$opcDificultad, $opcPaga,$categoriaActual);
                    ?>
                </div>
